...
public class CognitoAuthenticationService {
	 ...
	 * @user ihuaylupo(1.0)
	 */
	public  SpringSecurityUser authenticate(AuthenticationRequest authenticationRequest) throws CognitoException{
		...
		try {
			...
			SpringSecurityUser userAuthenticated = new SpringSecurityUser(authenticationRequest.getUsername(),authenticationRequest.getPassword());
	 ...
	 * @since 2018-08-09 
	 */
	public UserResponse getUserInfo(String accessToken) throws CognitoException {
		AWSCognitoIdentityProvider cognitoClient = getAmazonCognitoIdentityClient();
	 ...
	 * @since 2018-07-03 
	 */
	public UserSignUpResponse signUp(UserSignUpRequest signUpRequest) throws CognitoException{
	 ...
	 * @since 2018-07-03 
	 */
	public void signUpConfirmation(UserSignUpRequest signUpRequest) throws CognitoException{
	 ...
	 * @since 2018-07-04 
	 */
	public void addUserToGroup(String username, String groupname) throws CognitoException{
		AWSCognitoIdentityProvider cognitoClient = getAmazonCognitoIdentityClient();
	 ...
	 * @since 2018-07-16 
	 */
	public void deleteUser(String user) throws CognitoException{
		AWSCognitoIdentityProvider cognitoClient = getAmazonCognitoIdentityClient();
	 ...
	 * @since 2018-07-05 
	 */
	public String signOut(String accessToken, String username) throws CognitoException{
	...
	public PasswordResponse resetPassword(PasswordRequest passwordRequest) throws CognitoException{
	...
	public PasswordResponse confirmResetPassword(PasswordRequest passwordRequest) throws CognitoException{
		String username = passwordRequest.getUsername();
		AWSCognitoIdentityProvider cognitoClient = getAmazonCognitoIdentityClient();
